...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen w-full">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex min-h-[calc(100vh-88px)] flex-col justify-center px-6 pb-20 md:px-12 lg:px-16">
        <div className="max-w-2xl lg:max-w-3xl">
          ...
          <div className={cn(
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 backdrop-blur-sm px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-white/90">
          ...
          {/* Headline */}
          <h1 className={cn(
            "mb-6 text-4xl font-bold leading-[1.1] tracking-tight text-white text-balance md:text-5xl lg:text-6xl transition-all duration-700 delay-700 font-[family-name:var(--font-hero)]",
          ...
          {/* Description */}
          <p className={cn(
            "mb-10 max-w-xl text-base leading-relaxed text-white/75 md:text-lg transition-all duration-700 delay-[900ms]",
            isLoaded ? "md:opacity-100 md:translate-y-0" : "md:opacity-0 md:translate-y-8"
          )}>
          ...
          >
            <Link
              href="#contact"
              className="group inline-flex items-center gap-3 rounded-full bg-[#3c76ad] px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#3c76ad]/90 hover:scale-105 active:scale-95"
            >
            ...
            <a
              href="tel:+393497531904"
              className="group inline-flex items-center gap-3 rounded-full border border-white/40 bg-white/10 backdrop-blur-sm px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-white/20 hover:scale-105 active:scale-95"
            >
